...
extern "C" {
     ...
     */
    CO2_LIB_EXPORT struct hid_device_info * co2_enumerate(void);
     ...
     *      success or NULL on failure.
     */
    CO2_LIB_EXPORT co2_device * co2_raw_open_first_device(void);
     ...
     *      success or NULL on failure.
     */
    CO2_LIB_EXPORT co2_device * co2_open_first_device(void);
